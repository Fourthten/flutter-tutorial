        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                'Berada di jalur utama, Farm House menjadi objek wisata yang selalu ramai. Selain karena letaknya yang strategis, juga menghadirkan nuansa khas Eropa. Semua memiliki spot swafoto Instagramable.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 16.0,
                  fontFamily: 'Oxygen'
